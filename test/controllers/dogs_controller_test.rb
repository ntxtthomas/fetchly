...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference("Dog.count") do
      post dogs_url, params: { dog: { age: @dog.age, breed: @dog.breed, name: @dog.name, owner_id: @dog.owner_id, weight: @dog.weight } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { age: @dog.age, breed: @dog.breed, name: @dog.name, owner_id: @dog.owner_id, weight: @dog.weight } }
